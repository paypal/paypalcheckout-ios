/*! @file OIDTokenRequest.h
  ...
  Modified – Copyright (c) 2017-2018 PayPal
 */
...
@interface OIDTokenRequest : NSObject <NSCopying, NSSecureCoding> {
  ...
  NSString *_nonce;
  NSString *_proxyClientId;
  NSDictionary<NSString *, NSString *> *_additionalHeaderParameters;
...
@property(nonatomic, readonly, nullable) NSDictionary<NSString *, NSString *> *additionalHeaderParameters;
...
- (instancetype)initWithConfiguration:(OIDServiceConfiguration *)configuration
           ...
           additionalHeaderParameters:(nullable NSDictionary<NSString *, NSString *> *)additionalHeaderParameters
                 additionalParameters:(nullable NSDictionary<NSString *, NSString *> *)additionalParameters
